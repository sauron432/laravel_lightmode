...
/* The `return json_encode();` statement is encoding the `` array into a JSON string and
returning it. This allows the response to be sent back as JSON data, which can be easily parsed and
used by other applications or clients. */
