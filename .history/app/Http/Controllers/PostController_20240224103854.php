...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        {
            return redirect()->back()->withInput()->withErrors(['error'=>'There is an issue making post. Please contact admin.', 'error-details'=> $e->message]);
        }
    }
    ...
    public function commentStore(Request $request){
        ...
        try{
            ...
            $returnData["code"] = 200;
            $returnData["message"] = $request->comment;
            return ('success', 'Commented successfully');
        }catch(\Exception $e){
            return redirect()->back()->withInput()->withErrors(['error' => 'There is an issue making post. Please contact admin']);
        }
    }
