<x-app-layout>
    <div class="container">
        ...
        <?php
       /* The code block `  = ''; if (->any()) { foreach (->all() as ) {
        .= .'<br>'; } }` is responsible for collecting and formatting any validation
       error messages that may have occurred during form submission. */
        $error = '';
        if ($errors->any()) 
        {
