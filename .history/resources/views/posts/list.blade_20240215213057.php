    ...
    $(document).ready(function() {
        ...
        if ($('#success').val() == '') {
            Swal.fire({
                position: "top-end",
                icon: "success",
/* The line `title: $('#success').val(''),` is setting the title of the success message in the Swal
(SweetAlert) notification. It is retrieving the value of the element with the id "success" and
setting it as the title of the success message. */
                title: $('#success').val(''),
